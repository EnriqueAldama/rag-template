            ...
            <header className="fixed top-6 left-1/2 -translate-x-1/2 w-[90%] max-w-4xl z-50">
                <nav className="bg-white/[0.03] backdrop-blur-xl border border-white/10 px-6 py-3 rounded-full flex justify-between items-center shadow-[0_8px_32px_rgba(0,0,0,0.5)]">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <span className="font-semibold text-lg tracking-tight text-white hidden sm:block">Lumina<span className="text-purple-400 font-medium">B2B</span></span>
                    </div>

                    {/* Nav Links */}
                    <div className="flex items-center gap-6">
                        <button className="text-sm font-medium text-gray-400 hover:text-white transition-colors">Dashboard</button>
